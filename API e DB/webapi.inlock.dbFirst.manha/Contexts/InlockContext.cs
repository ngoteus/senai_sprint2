...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=NOTE04-S14; Initial Catalog= inlock_games_dbFirst_manha; User Id=sa; Pwd=Senai@134; TrustServerCertificate=true;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Estudio>(entity =>
        {
            entity.HasKey(e => e.IdEstudio).HasName("PK__Estudio__0C3B4355867301A9");
        ...
        {
            entity.HasKey(e => e.IdJogo).HasName("PK__Jogo__69E08513C06E9ACC");
        ...
        {
            entity.HasKey(e => e.IdTipoUsuario).HasName("PK__TiposUsu__CA04062B9990E007");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__5B65BF97422D0FA2");
